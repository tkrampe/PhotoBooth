...
namespace Utilities
{
    public static class MouseTools
    {
        ...
        {
            DoButtonInput(MouseButtonToMouseDownEvent(button));
        }

        public static void ButtonUp(Button button)
        {
            DoButtonInput(MouseButtonToMouseUpEvent(button));
        }

        public static void Click(Button button)
        {
            Click(button, Speed.Normal);
        }

        public static void Click(Button button, Speed speed) 
        {
            ButtonDown(button);
        ...
        public static void Click(Button button, System.Drawing.Point pt) 
        {
            Move(pt);
            Click(button);
        }
        ...
        private static Win32API.MOUSEEVENTF MouseButtonToMouseDownEvent(Button button)
        {
            switch(button)
            {
                case Button.Right:
                    return Win32API.MOUSEEVENTF.RIGHTDOWN;
                case Button.Middle:
                    return Win32API.MOUSEEVENTF.MIDDLEDOWN;
                default:
                    return Win32API.MOUSEEVENTF.LEFTDOWN;
            }
        }

        private static Win32API.MOUSEEVENTF MouseButtonToMouseUpEvent(Button button)
        {
            switch (button)
            {
                case Button.Right:
                    return Win32API.MOUSEEVENTF.RIGHTUP;
                case Button.Middle:
                    return Win32API.MOUSEEVENTF.MIDDLEUP;
                default:
                    return Win32API.MOUSEEVENTF.LEFTUP;
            }
        }
               
        private static int CalculateAbsoluteCoordinateX(int x)
        {
            return (x * 65536) / Win32API.GetSystemMetrics(Win32API.SystemMetric.SM_CXSCREEN);
        }
        ...
        private static void ExampleKeyInput()
        {
            var pInputs = new[]
            {
                new Win32API.INPUT()
                {
                    ...
                    U = new Win32API.InputUnion()
                    {
                        ...
                        {
                            wScan = Win32API.ScanCodeShort.KEY_S,
                            wVk = Win32API.VirtualKeyShort.KEY_S
                        }    
                    }
                }
            };
